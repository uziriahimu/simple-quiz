...
const Blog = () => {
    return (
        <div className=' text-2xl mt-16 '>
            <h3> <strong>Question:</strong> What is the purpose of react router?</h3>
            ...
            <h3> <strong>Question:</strong>How does context API work</h3>
            ...
            <h3> <strong>Question:</strong>What is useRef</h3>
